...
import {MODAL_SATOSHI, MODAL_DEPOSIT, MODAL_WITHDRAW, PANEL_SETTINGS, MODAL_TRANSACTIONS, MODAL_AFFILIATE} from 'ducks/windows';
    ...
    return (
      <div styleName="header">
        <div styleName="nav">
          ...
          <div styleName="nav-item" onClick={() => openModal(MODAL_TRANSACTIONS)}>Transactions</div>
          <div styleName="nav-item" onClick={() => openModal(MODAL_AFFILIATE)}>Affiliate</div>
