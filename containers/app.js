...
import {login, register, loginOrRegister, getUserInfo, askSatoshi, logout, getLocalStorage, updateUserInfo, withdraw,
  getTransactions, requestReferralBonus} from 'ducks/user';
...
class App extends React.Component {
  ...
  render() {
    ...
    const {login, register, loginOrRegister, getUserInfo, askSatoshi, logout, updateUserInfo, withdraw, getTransactions,
      requestReferralBonus} = this.props.userActions;
    ...
    return (
      <div>
        ...
        <Modals type={windows.openedModal}
                ...
                requestReferralBonus={requestReferralBonus}
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    userActions:  bindActionCreators({login, register, loginOrRegister, getUserInfo, askSatoshi, logout,
      getLocalStorage, updateUserInfo, withdraw, getTransactions, requestReferralBonus}, dispatch),
